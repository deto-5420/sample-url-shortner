...
b[u].replace(/\+/g," "),v=b[u].split("="),f.push([decodeURIComponent(v[0]),decodeURIComponent(v[1])]);for(b=0;b<f.length;b++)f[b]&&n.append(f[b][0],f[b][1])}a.data=null;f=c.extend(!0,{},c.ajaxSettings,a,{contentType:!1,processData:!1,cache:!1,type:g||"POST"});a.uploadProgress&&(f.xhr=function(){var b=jQuery.ajaxSettings.xhr();b.upload&&(b.upload.onprogress=function(b){var c=0,e=b.loaded||b.position,f=b.total;b.lengthComputable&&(c=Math.ceil(100*(e/f)));a.uploadProgress(b,e,f,c)});return b});f.data=
null;var C=f.beforeSend;f.beforeSend=function(a,b){b.data=n;C&&C.call(this,a,b)};z=c.ajax(f)}else z=c.ajax(a);l.removeData("jqxhr").data("jqxhr",z);for(f=0;f<q.length;f++)q[f]=null;this.trigger("form-submit-notify",[this,a]);return this};c.fn.ajaxForm=function(a){a=a||{};a.delegation=a.delegation&&c.isFunction(c.fn.on);if(!a.delegation&&0===this.length){var e=this.selector,g=this.context;if(!c.isReady&&e)return r("DOM not ready, queuing ajaxForm"),c(function(){c(e,g).ajaxForm(a)}),this;r("terminating; zero elements found by selector"+
(c.isReady?"":" (DOM not ready)"));return this}return a.delegation?(c(document).off("submit.form-plugin",this.selector,n).off("click.form-plugin",this.selector,v).on("submit.form-plugin",this.selector,a,n).on("click.form-plugin",this.selector,a,v),this):this.ajaxFormUnbind().bind("submit.form-plugin",a,n).bind("click.form-plugin",a,v)};c.fn.ajaxFormUnbind=function(){return this.unbind("submit.form-plugin click.form-plugin")};c.fn.formToArray=function(a,e){var g=[];if(0===this.length)return g;var b=
this[0],l=a?b.getElementsByTagName("*"):b.elements;if(!l)return g;var j,q,f,m,k,n;j=0;for(n=l.length;j<n;j++)if(k=l[j],f=k.name)if(a&&b.clk&&"image"==k.type)!k.disabled&&b.clk==k&&(g.push({name:f,value:c(k).val(),type:k.type}),g.push({name:f+".x",value:b.clk_x},{name:f+".y",value:b.clk_y}));else if((m=c.fieldValue(k,!0))&&m.constructor==Array){e&&e.push(k);q=0;for(k=m.length;q<k;q++)g.push({name:f,value:m[q]})}else if(A&&"file"==k.type&&!k.disabled)if(e&&e.push(k),m=k.files,m.length)for(q=0;q<m.length;q++)g.push({name:f,
value:m[q],type:k.type});else g.push({name:f,value:"",type:k.type});else null!==m&&"undefined"!=typeof m&&(e&&e.push(k),g.push({name:f,value:m,type:k.type,required:k.required}));if(!a&&b.clk&&(l=c(b.clk),j=l[0],(f=j.name)&&!j.disabled&&"image"==j.type))g.push({name:f,value:l.val()}),g.push({name:f+".x",value:b.clk_x},{name:f+".y",value:b.clk_y});return g};c.fn.formSerialize=function(a){return c.param(this.formToArray(a))};c.fn.fieldSerialize=function(a){var e=[];this.each(function(){var g=this.name;
if(g){var b=c.fieldValue(this,a);if(b&&b.constructor==Array)for(var l=0,j=b.length;l<j;l++)e.push({name:g,value:b[l]});else null!==b&&"undefined"!=typeof b&&e.push({name:this.name,value:b})}});return c.param(e)};c.fn.fieldValue=function(a){for(var e=[],g=0,b=this.length;g<b;g++){var l=c.fieldValue(this[g],a);null===l||("undefined"==typeof l||l.constructor==Array&&!l.length)||(l.constructor==Array?c.merge(e,l):e.push(l))}return e};c.fieldValue=function(a,e){var g=a.name,b=a.type,l=a.tagName.toLowerCase();
void 0===e&&(e=!0);if(e&&(!g||a.disabled||"reset"==b||"button"==b||("checkbox"==b||"radio"==b)&&!a.checked||("submit"==b||"image"==b)&&a.form&&a.form.clk!=a||"select"==l&&-1==a.selectedIndex))return null;if("select"==l){var j=a.selectedIndex;if(0>j)return null;for(var g=[],l=a.options,n=(b="select-one"==b)?j+1:l.length,j=b?j:0;j<n;j++){var f=l[j];if(f.selected){var m=f.value;m||(m=f.attributes&&f.attributes.value&&!f.attributes.value.specified?f.text:f.value);if(b)return m;g.push(m)}}return g}return c(a).val()};
c.fn.clearForm=function(a){return this.each(function(){c("input,select,textarea",this).clearFields(a)})};c.fn.clearFields=c.fn.clearInputs=function(a){var e=/^(?:color|date|datetime|email|month|number|password|range|search|tel|text|time|url|week)$/i;return this.each(function(){var g=this.type,b=this.tagName.toLowerCase();if(e.test(g)||"textarea"==b)this.value="";else if("checkbox"==g||"radio"==g)this.checked=!1;else if("select"==b)this.selectedIndex=-1;else if("file"==g)/MSIE/.test(navigator.userAgent)?
c(this).replaceWith(c(this).clone()):c(this).val("");else if(a&&(!0===a&&/hidden/.test(g)||"string"==typeof a&&c(this).is(a)))this.value=""})};c.fn.resetForm=function(){return this.each(function(){("function"==typeof this.reset||"object"==typeof this.reset&&!this.reset.nodeType)&&this.reset()})};c.fn.enable=function(a){void 0===a&&(a=!0);return this.each(function(){this.disabled=!a})};c.fn.selected=function(a){void 0===a&&(a=!0);return this.each(function(){var e=this.type;"checkbox"==e||"radio"==
e?this.checked=a:"option"==this.tagName.toLowerCase()&&(e=c(this).parent("select"),a&&(e[0]&&"select-one"==e[0].type)&&e.find("option").selected(!1),this.selected=a)})};c.fn.ajaxSubmit.debug=!1})(jQuery);